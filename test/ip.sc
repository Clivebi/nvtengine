...
func forge_ipv6_packet(){

}

func dump_ipv6_packet(){

}

func forge_ip_packet(){

}

func forge_ip_v6_packet(){
}
...
func dump_ip_v6_packet(){

}

func forge_tcp_packet(){

}

func forge_tcp_v6_packet(){

}

func get_tcp_element(){

}

func get_tcp_v6_element(){

}

func dump_tcp_packet(){

}

func dump_tcp_v6_packet(){

}

func forge_udp_packet(){

}

func forge_udp_v6_packet(){

}

func get_udp_element(){

}

func get_udp_v6_element(){

}

func dump_udp_packet(){

}

func dump_udp_v6_packet(){
...
func dump_icmp_packet(){

}

func dump_icmp_v6_packet(){
...
func test_udp(){
    ...
    var _ip_hdr = build_ipv4_header(5,0,00,0xd83e,0,0,64,17,ipv4StringToAddress("192.168.4.149"),ipv4StringToAddress("114.114.114.114"));
...
func test_tcp_option(){
    var _ip_hdr =  build_ipv4_header(5,00,00,0,2,0,64,6,ipv4StringToAddress("192.168.4.149"),ipv4StringToAddress("23.202.34.33"));
...
func test_tcp_payload(){
    ...
    var _ip_hdr =  build_ipv4_header(5,2,00,0xC44f,2,0,47,6,ipv4StringToAddress("23.202.34.33"),ipv4StringToAddress("192.168.4.149"));
